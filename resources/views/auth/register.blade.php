...
<div class="zyl_lofo_main" style="height: 450px">
    ...
    <div class="layui-row layui-col-space15">
        <form class="layui-form zyl_pad_01" action="">
            ...
            <div class="layui-col-sm12 layui-col-md12">
                <div class="layui-form-item">
                    <input type="password" name="confirmed" lay-verify="required|pass" autocomplete="off"
                           placeholder="重复输入密码"
                           class="layui-input">
                    <i class="layui-icon layui-icon-password zyl_lofo_icon"></i>
                </div>
            ...
            <div class="layui-col-sm12 layui-col-md12">
                <div class="layui-form-item">
                    <input type="text" name="phone" lay-verify="required|pass" autocomplete="off" placeholder="手机号"
                           class="layui-input">
                    <i class="layui-icon layui-icon-password zyl_lofo_icon"></i>
                </div>
            </div>
            ...
            <div class="layui-col-sm12 layui-col-md12">
                <div class="layui-form-item">
                    <input type="email" name="email" lay-verify="required" autocomplete="off" placeholder="邮箱"
                           class="layui-input">
                    <i class="layui-icon layui-icon-password zyl_lofo_icon"></i>
                </div>
            </div>
